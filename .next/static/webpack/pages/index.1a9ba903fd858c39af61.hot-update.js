...
})(["background:#212D45;border-radius:12px;height:224px;padding:54px;@media ", "{height:210px;}@media ", "{height:135px;padding:16px;}@media ", "{height:110px;padding:12px;&:nth-child(2n){grid-row:2;}}"], function (props) {
